...
base_dir="/home/binhnguyen/.config/eww/scripts/spotify/"
...
#         curl --output "${base_dir}image.jpg" "$album_art_url"
#
...
album_art_url=$(get_album_art_url)
curl --output "${base_dir}image.jpg" "$album_art_url"
echo "/home/binhnguyen/.config/eww/scripts/spotify/image.jpg"
